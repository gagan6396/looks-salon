      ...
      <div className="relative h-[520px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-center px-16">
          ...
          <Link href="/contact-us">
            <button
              className="w-fit border border-white text-white text-xs tracking-[0.35em] uppercase px-10 py-4 hover:bg-white hover:text-gray-900 transition-all duration-300 cursor-pointer"
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              Contact Us
            </button>
